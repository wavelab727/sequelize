  ...
  static sync(options) {
    ...
    return Promise.try(() => {
      ...
      .then(() => {
        if (options.alter) {
          return Promise.all([
            this.QueryInterface.describeTable(this.getTableName(options), options),
            this.QueryInterface.getForeignKeyReferencesForTable(this.getTableName(options), options)
          ])
            .then(tableInfos => {
              ...
              _.each(attributes, (columnDesc, columnName) => {
                if (!columns[columnName]) {
                  changes.push(() => this.QueryInterface.addColumn(this.getTableName(options), columnName, attributes[columnName], options));
                }
              });
              _.each(columns, (columnDesc, columnName) => {
                ...
                if (!currentAttributes) {
                  ...
                  changes.push(() => this.QueryInterface.changeColumn(this.getTableName(options), columnName, attributes[columnName], options));
                }
              });
